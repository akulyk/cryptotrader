...
class Wex extends AbstractExchangeService
{
    const API_INFO = 'https://wex.nz/api/3/info';
    const API_DEPTH = 'https://wex.nz/api/3/depth/';
    const API_TICKET = 'https://wex.nz/api/3/ticker/';
    const API_TRADES = 'https://wex.nz/api/3/trades/';
